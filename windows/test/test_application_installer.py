...
class InstallApplicationTest(unittest.TestCase, TestHelpers):
    ...
    def test_run_kills_thread_correctly_on_exception(self, mock_urlib2, mock_ZipFile, mock_move, mock_listdir, mock_isdir):
    ...
    def test_run_downloads_zip_file_from_correct_path(self, mock_urlib2, mock_ZipFile, mock_move, mock_listdir, mock_isdir):
    ...
    def test_run_should_report_failure_if_response_is_not_200(self, mock_urlib2, mock_ZipFile, mock_move, mock_listdir, mock_isdir):
    ...
    def test_run_should_report_failure_if_cannot_open_file(self, mock_urlib2, mock_ZipFile, mock_move, mock_listdir, mock_isdir):
    ...
    def test_run_should_save_file(self, mock_urlib2, mock_ZipFile, mock_move, mock_listdir, mock_isdir):
    ...
    def test_run_should_repoort_saving_file(self, mock_urlib2, mock_ZipFile, mock_move, mock_listdir, mock_isdir):
        expected_data = "abba" * 1024 * 1024
        mock_urlib2.urlopen.return_value = self.get_mock_response(code=200, data=expected_data)
        app = self.get_application()
        mock_open_file = mock_open()
    ...
    def test_run_should_report_steps(self, mock_urlib2, mock_ZipFile, mock_move, mock_listdir, mock_isdir):
    ...
    def test_run_should_unzip_dowwnloaded_file(self, mock_urlib2, mock_ZipFile, mock_move, mock_listdir, mock_isdir):
        mock_urlib2.urlopen.return_value = self.get_mock_response(code=200)
        app = self.get_application()
    ...
    def test_run_should_report_error_if_fails_to_unzip_dowwnloaded_file(self, mock_urlib2, mock_ZipFile, mock_move, mock_listdir, mock_isdir):
        mock_urlib2.urlopen.return_value = self.get_mock_response(code=200)
        app = self.get_application()
        mock_complete_callback = MagicMock()
    ...
    def test_run_should_move_inner_folder_of_unpacked_zip_to_install_folder(self, mock_urlib2, mock_ZipFile, mock_move, mock_listdir, mock_isdir):
        app = self.get_application()
        base_folder = 'c:\\some\\folder'
        internal_path = 'somerthing-1234.2314'
        mock_listdir.return_value = [internal_path]
